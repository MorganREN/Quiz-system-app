...
CREATE TABLE `Student` (
  ...
  UNIQUE KEY `Student_ID` (`Student_ID`,`Username`),
...
INSERT INTO `Student` VALUES (1234,'Mohan','REN','m33394mr'),(123456,'Nice','TA','NiceTA'),(31331122,'11','11','ee'),(38390010,'mo','mo','momo');
